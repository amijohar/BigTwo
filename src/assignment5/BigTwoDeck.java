 ...
 * in a Big Two card game. It overrides the initialize() method it inherited from the Deck
...
public class BigTwoDeck extends Deck 
{
	...
	/** 
	 * a method for initializing a deck of Big Two cards. It should remove
